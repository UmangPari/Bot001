...
var asName='Example';
var info, asId,inputApp='null', appId='',timeRangeFlag=-1,asEndTime,asEndDate,asStartTime,asStartDate,asFinal;
var flag=-1;
        ...
        else if(info=='Delete')
        {
            ...
            await axios.get(`${appdLink}/controller/alerting/rest/v1/applications/${appId}/action-suppressions`,
               ...
               {     
                    ...
                    flag=-1;  //reset value of flag to -1
               }    
